...
import { TempatIbadahTable } from "./TempatIbadahTable";
import { TempatIbadahFormModal } from "./TempatIbadahFormModal";
import { useTempatIbadahs } from "../hooks/useTempatIbadahs";
import { categories } from "../constants";

export const TempatIbadahAdminPage: React.FC = () => {
  const {
    page,
    data,
    isLoading,
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">
            Manajemen Data Tempat Ibadah
          </h1>
          <p className="text-gray-500 text-sm mt-1">
            Kelola direktori tempat ibadah di KUA Karawang Barat
          </p>
        </div>
        <Button
