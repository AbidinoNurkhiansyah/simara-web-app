...
export function LayananSection() {
  return (
    <section className="container-custom pt-10 md:pt-20 pb-6 md:pb-10">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        {services.map((svc) => (
          <Link
            key={svc.title}
            to={svc.path}
            className="flex flex-col bg-white rounded-xl sm:rounded-2xl overflow-hidden border border-gray-100 shadow-md hover:shadow-xl transition-all duration-300 group relative"
          >
